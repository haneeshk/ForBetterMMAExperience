...
Dynamic[Refresh[ProgressIndicator[x,{ttotal,0},BaseStyle->ControlsRendering->"Generic"],UpdateInterval->1]],Dynamic[Refresh[PaddedForm[Grid[{{x*ttotal,"minutes"}}],{6,2},NumberPadding->{"0", "0"}],UpdateInterval->1]]}}]]
